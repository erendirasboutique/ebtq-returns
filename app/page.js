...
const text = {
  en: {
    ...
    returnPassword: "Return Authorization Code",
    returnPasswordPlaceholder: "Enter your return code",
    returnPolicyLink: "Read our Return Policy →",
    carrier: "Carrier",
  ...
  es: {
    ...
    returnPassword: "Código de autorización de devolución",
    returnPasswordPlaceholder: "Ingresa tu código de devolución",
    returnPolicyLink: "Leer nuestra política de devoluciones →",
    ...
    <main className="page">
      ...
      <section className="hero">
        <div className="intro">
          ...
          <div className="warning">
            ...
            <a
              ...
              href="https://www.erendirasboutique.com/return-policy"
              target="_blank"
        ...
        <form className="card" onSubmit={handleSubmit}>
          ...
          <label>{t.returnPassword}</label>
          <input
            name="returnPassword"
            type="password"
            placeholder={t.returnPasswordPlaceholder}
            required
          />
